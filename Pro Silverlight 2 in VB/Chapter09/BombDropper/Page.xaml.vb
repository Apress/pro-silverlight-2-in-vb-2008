...
Partial Public Class Page
    ...
    ' Make it possible to look up a bomb based on a storyboard,
    ' and vice versa.
    Private storyboards As New Dictionary(Of Bomb, Storyboard)
    Private bombs As New Dictionary(Of Storyboard, Bomb)
    ...
    Private Sub bombTimer_Tick(ByVal sender As Object, ByVal e As EventArgs)
        ...
        bomb.SetValue(Canvas.LeftProperty, CDbl(random.Next(0, canvasBackground.ActualWidth - 50)))
        ...
        ' Add the bomb and the storyboard to two collections for easy tracking.
    ...
    Private Sub storyboard_Completed(ByVal sender As Object, ByVal e As EventArgs)
        Dim completedStoryboard As Storyboard = CType(sender, Storyboard)
        Dim completedBomb As Bomb = bombs(completedStoryboard)
        ...
        If droppedCount >= maxDropped Then
            bombTimer.Stop()
            lblStatus.Text += Environment.NewLine & Environment.NewLine & "Game over."
        ...
        Else
            ' Remove the storyboard using a private method.
            CleanUpStoryboard(completedStoryboard)
        End If
    End Sub

    Private Sub CleanUpStoryboard(ByVal storyboard As Storyboard)
        storyboard.Stop()

        Dim bomb As Bomb = bombs(storyboard)
        storyboards.Remove(bomb)
        bombs.Remove(storyboard)
